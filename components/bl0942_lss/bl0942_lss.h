...
// The BL0942_LSS IC is "calibration-free", which means that it doesn't care
...
// to calculate BL0942_LSS_UREF and BL0942_LSS_IREF. Those are in units of
// "305978 counts per amp" or "73989 counts per volt" respectively.
//
// We can derive BL0942_LSS_PREF from those. Let's eliminate the weird
...
// BL0942_LSS_PREF = BL0942_LSS_UREF * BL0942_LSS_IREF * 3537 / 305978 / 73989.
//
...
// Factoring in the calibration, that's 419230.4 / BL0942_LSS_PREF actual
...
// CF_CNT * 419230.4 / BL0942_LSS_PREF / 3600000
//
// Which makes BL0952_EREF = BL0942_LSS_PREF * 3600000 / 419430.4

static const float BL0942_LSS_PREF = 596;              // taken from tasmota
static const float BL0942_LSS_UREF = 15873.35944299;   // should be 73989/1.218
static const float BL0942_LSS_IREF = 251213.46469622;  // 305978/1.218
static const float BL0942_LSS_EREF = 3304.61127328;    // Measured
...
class BL0942_LSS : public PollingComponent, public uart::UARTDevice {
 public:
 ...
 protected:
  ...
  float power_reference_ = BL0942_LSS_PREF;
  bool power_reference_set_ = false;
  // Divide by this to turn into Volt
  float voltage_reference_ = BL0942_LSS_UREF;
  bool voltage_reference_set_ = false;
  // Divide by this to turn into Ampere
  float current_reference_ = BL0942_LSS_IREF;
  bool current_reference_set_ = false;
  // Divide by this to turn into kWh
  float energy_reference_ = BL0942_LSS_EREF;
