...
bl0942_lss_ns = cg.esphome_ns.namespace("bl0942_lss")
BL0942_LSS = bl0942_lss_ns.class_("BL0942_LSS", cg.PollingComponent, uart.UARTDevice)

LineFrequency = bl0942_lss_ns.enum("LineFrequency")
LINE_FREQS = {
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(BL0942_LSS),
